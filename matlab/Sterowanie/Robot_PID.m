...
Phi_0 = 0;  % <- wartosc poczatkowa wychylenia [stopnie]
Phi_y = 0;  % <- wartosc zadana wychylenia [stopnie]

[t] = sim('Robot_PID_model.slx', czas);
...
xlabel('Czas [s]');
ylabel('Pozycja [m]');
legend('X - wspolrzedna pozioma srodka kola robota');
