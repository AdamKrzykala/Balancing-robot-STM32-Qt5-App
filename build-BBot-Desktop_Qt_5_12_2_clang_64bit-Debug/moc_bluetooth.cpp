...
QT_MOC_LITERAL(1, 10, 15), // "Parsed_Frame_OK"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 17) // "Parsed_Frame_FAIL"

    },
    "Bluetooth\0Parsed_Frame_OK\0\0Parsed_Frame_FAIL"
};
...
void Bluetooth::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Parsed_Frame_OK(); break;
        case 1: _t->Parsed_Frame_FAIL(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Bluetooth::Parsed_Frame_OK)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Bluetooth::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Bluetooth::Parsed_Frame_FAIL)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Bluetooth::Parsed_Frame_OK()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Bluetooth::Parsed_Frame_FAIL()
{
